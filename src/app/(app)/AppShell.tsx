    ...
    <div className="min-h-screen bg-zinc-950 text-white flex">
      ...
      <aside className="w-72 border-r border-white/10 p-6 space-y-6">
        ...
        <div className="pt-4">
          <button
            ...
            className="w-full px-4 py-3 rounded-xl bg-red-500/15 hover:bg-red-500/25 text-red-200 border border-red-400/20 transition"
            type="button"
          >
            Log Out
          </button>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 border-b border-white/10 flex items-center justify-between px-6">
          <div className="text-lg font-semibold">MachadosIrrigation</div>
